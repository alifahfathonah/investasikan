	...
	<section>
	 ...
	 <div id="contact-page" class="container">
    		...
    		<div class="row">  	
	    		<div class="col-sm-8">
						<br><br>
	    				<h2 class="title text-center" style="color: #FC456A">PERBARUAN INVESTASI</h2>
				...
				<table class="table table-bordered">
					...
					<tbody>
						...
						<td>
							<a href="index.php/pemilik/perbaruan/lihat/<?php echo $row->kode_barang; ?>" class="btn btn-danger">Lihat</a>
						</td>
						</tr>
											<?php
		}
