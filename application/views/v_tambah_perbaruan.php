	 ...
	 <div id="contact-page" class="container">
    		...
    		<div class="row">  	
	    		<div class="col-sm-8">
	    				...
	    				<h2 class="title text-center" style="color: #FC456A">TAMBAH PERBARUAN INVESTASI</h2>
        ...
        <tr>
          ...
          <td>
            <input type='text' name='kode_barang' value="<?php echo $this->uri->segment('5'); ?>" style="color:red" class='form-control' required='required' disabled="disable">
              <input type="hidden" name="kode_barang" value="<?php echo $this->uri->segment('5'); ?>">
