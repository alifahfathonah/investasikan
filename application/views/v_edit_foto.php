	 ...
	 <div id="contact-page" class="container">
    		...
    		<div class="row">  	
	    		<div class="col-sm-8">
	    				...
	    				<?php echo form_open_multipart('member/edit_foto') ?>
	    				<table>
	    					<tr>
	    						...
	    						<table class="table table-condensed">
	    							<tr>
	    								...
	    								<td>:</td>
	    								<td>
											<?php if($akses == "member") { echo $keys->nama_member; echo "<input type='hidden' name='id' value='$keys->id_member'>"; echo "<input type='hidden' name='username' value='$keys->nama_member'>"; echo "<input type='hidden' name='akses' value='$akses'>"; } elseif($akses == "pemilik"){ echo "<input type='hidden' name='id' value='$keys->id_pemilik'>"; echo $keys->nama_pemilik;  echo "<input type='hidden' name='username' value='$keys->nama_pemilik'>";  echo "<input type='hidden' name='akses' value='$akses'>"; } ?>
											<input type="hidden" name="akses" value="<?php echo $this->uri->segment('4'); ?>">
											<input type="hidden" name="member" value="<?php echo $this->uri->segment('5'); ?>">
											<input type="hidden" name="jenis" value="<?php echo $this->uri->segment('3'); ?>">
										</td>
	    							</tr>
	    							<tr>
	    								<td>Foto <?php echo $this->uri->segment('3'); ?></td>
	    								<td>:</td>
	    							...
	    							<tr>
	    								<td colspan="3"><input type="submit" name="edit_foto" class="btn btn-warning" value="Edit" style="color: #FC456A"></td>
	    							</tr>
	    						</table>	
</td>
	    					</tr>
