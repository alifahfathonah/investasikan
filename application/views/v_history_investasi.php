				...
				<div class="col-sm-3">
					<div class="left-sidebar">
						...
						<div class="panel-group category-products" id="accordian"><!--category-productsr-->
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title"><a href="index.php/member/history_investasi"><font color="orange">Riwayat Investasi</font></a></h4>
								</div>
							</div>
							<div class="panel panel-default">
								<div class="panel-heading">
				...
				<table class="table table-bordered">
					<thead>
						<tr class="cart_menu" style="background-color: #FC456A">
							...
							<td class="quantity">Tanggal Investasi</td>
					...
					<tbody>
						<tr>
								...
								<?php 
									...
									$data = "SELECT * FROM tbl_cart where id_member = '$id_member' AND konfirmasi='1'";
							...
							<td class="cart_quantity">
								<p><?php echo $row->tanggal_belanja; ?></p>
								
							</td>
							<td class="cart_total">
								<p class="cart_total_price"><?php echo number_format($row->harga, 2); ?></p>
							</td>
							...
							<?php 
								...
								<p class="cart_quantity">
									<div style="color:green">TERBAYAR</div>
								</p>
							</td>
									<?php
								}else{
