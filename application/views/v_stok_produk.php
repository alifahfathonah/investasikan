	...
	<section>
				...
				<div class="col-sm-3">
					<div class="left-sidebar">
						...
						<div class="panel-group category-products" id="accordian"><!--category-productsr-->
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title"><a href="index.php/pemilik/stok/"><font color="#FC456A">Stok Produk Investasi</font></a></h4>
								</div>
							</div>							
							<div class="panel panel-default">
								<div class="panel-heading">
	 ...
	 <div id="contact-page" class="container">
    		...
    		<div class="row">  	
	    		<div class="col-sm-8">
						<br><br>
	    				<h2 class="title text-center" style="color: #FC456A">TAMBAH STOK PRODUK INVESTASI</h2>
        ...
        <tr>
          ...
          <td>
              ...
              <?php 
					$this->db->where('id_pemilik', $nama_member);
         ...
         <tr>
          ...
          <td>
             <input type='number' name='jumlah_stok' placeholder='jumlah stok' class='form-control'  value='' >
										...
										<input type="submit" name="stok" class="btn btn-danger" value="Simpan">
									</form>
									<br/>
									<br/>
									<br/>
