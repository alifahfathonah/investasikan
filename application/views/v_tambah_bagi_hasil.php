	 ...
	 <div id="contact-page" class="container">
    		...
    		<div class="row">  	
	    		<div class="col-sm-8">
	    				...
	    				<h2 class="title text-center" style="color: #FC456A">TAMBAH BAGI HASIL</h2>
						<div class="tab-pane fade active in" id="reviews" >
								<div class="col-sm-12">
									<?php echo form_open_multipart('') ?>
										<table class="table">
        <tr class="success"><th colspan="2">INPUT DATA BAGI HASIL</th></tr>
        <tr>
          <td width="150">Kode Barang</td>
          <td>
            <input type='text' name='kode_barang' value="<?php echo $this->uri->segment('6'); ?>" style="color:red" class='form-control' required='required' disabled="disable">
              <input type="hidden" name="kode_barang" value="<?php echo $this->uri->segment('6'); ?>">
              <input type="hidden" name="cart" value="<?php echo $this->uri->segment('5'); ?>">
              <input type="hidden" name="member" value="<?php echo $this->uri->segment('4'); ?>">
              <input type="hidden" name="pemilik" value="<?php echo $id_member; ?>">
		</tr>
		<?php
			$kode = $this->uri->segment('6');
			$a_barang = $this->db->query("SELECT nama_barang FROM tbl_barang WHERE kode_barang='$kode'")->row();
			
		?>
        <tr>
          <td width="150">Nama Barang</td>
          <td>
            <input type='text' name='nama_barang' value="<?php echo $a_barang->nama_barang; ?>" style="color:red" class='form-control' required='required' disabled="disable">
              <input type="hidden" name="nama_barang" value="<?php echo $a_barang->nama_barang; ?>">
		</tr>
        <tr>
