				...
				<div class="col-sm-3">
					<div class="left-sidebar">
						...
						<div class="panel-group category-products" id="accordian"><!--category-productsr-->
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title"><a href="index.php/member/bagi_hasil"><font color="#FC456A">Bagi Hasil</font></a></h4>
								</div>
							</div>
					...
					<tbody>
						<?php	
								...
								<?php 
									...
									$data = "SELECT * FROM tbl_bagi_hasil where id_member = '$id_member' AND konfirmasi='1'";
