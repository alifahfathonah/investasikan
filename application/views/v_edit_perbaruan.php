...
<body>
	 ...
	 <div id="contact-page" class="container">
    		...
    		<div class="row">  	
	    		<div class="col-sm-8">
	    				...
	    				<h2 class="title text-center" style="color: #FC456A">EDIT PERBARUAN INVESTASI</h2>
    ...
    <?php foreach ($data->result() as $row) : ?>
        ...
        <tr class="success"><th colspan="2">EDIT DATA PERBARUAN INVESTASI</th></tr>
        <tr>
          ...
          <td>
            ...
            <input type='hidden' name='kode' value="<?php echo $row->kode_barang; ?>">
              <input type="hidden" name="id_perbaruan" value="<?php echo $row->id_perbaruan; ?>">
              <input type="hidden" name="member" value="<?php echo $row->id_member; ?>">
		</tr>
        <tr>
        <td>Isi</td>
          <td><textarea name="isi" id="news"><?php echo $row->isi_perbaruan; ?></textarea>
