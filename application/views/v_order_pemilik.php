	...
	<section>
				...
				<div class="col-sm-3">
					<div class="left-sidebar">
						...
						<div class="panel-group category-products" id="accordian"><!--category-productsr-->
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title"><a href="index.php/pemilik/history_order"><font color="#FC456A">Pemberitahuan Pemesanan</font></a></h4>
								</div>
							</div>
							<div class="panel panel-default">
								<div class="panel-heading">
	 ...
	 <div id="contact-page" class="container">
    		...
    		<div class="row">  	
	    		<div class="col-sm-8">
						<br><br>
	    				<h2 class="title text-center" style="color: #FC456A">Riwayat Pemesanan</h2>
					...
					<tbody>
								...
								<?php 
									...
									$result = $this->db->query($data);
										...
										foreach ($result->result() as $row) {
											$d_invest = "SELECT * FROM tbl_cart WHERE kode_barang = '$row->kode_barang' ORDER BY tanggal_belanja DESC";
							...
							<td>
								...
								<p class="cart_quantity">
									...
									<td class="cart_quantity">
								<p class="cart_quantity">
									<div style="color:red" class="alert alert-warning">BELUM DIBAYAR</div>
								</p>
							</td>
									<?php
								}
